...
<body>
        ...
        <main class="side_bara">
            ...
            <div class="content_sideA" id="content_sideA">
                ...
                <table id="table" class="container-table" cellspacing="0" cellpadding="5">
                    ...
                    <tr>
                        <th colspan="4" class="ordem">&nbsp;Prontuário:&nbsp;&nbsp;&nbsp;</th>
                        <th colspan="6" class="ordem" colspan="3">&nbsp;Nome:&nbsp;&nbsp;&nbsp;</th>
                    </tr>
                    <tr>
                        <th colspan="4" class="ordem">&nbsp;Prontuário:&nbsp;&nbsp;&nbsp;</th>
                        <th colspan="6" class="ordem" colspan="3">&nbsp;Nome:&nbsp;&nbsp;&nbsp;</th>
                    ...
                    <tr>
                        ...
                        <th colspan="3" class="title"><?= $result[0]->GUI_INATIVO ?></th>
                    </tr>
                    <tr>
                        ...
                        <th colspan="3" class="title"><?= $result[0]->TRI_INATIVO ?></th>
                    </tr>
                    <tr>
                        ...
                        <th colspan="3" class="title"><?= $result[0]->TB_INATIVO ?></th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <th colspan="1" class="fechamento"><?= $guiches[0]->GUICHE_PRATA ?></th>
                        <th colspan="1" class="fechamento"><?= $pastas[0]->PASTA_PRATA ?></th>
                        <th colspan="1" class="fechamento"><?= $pastas[0]->COF_PRATA ?></th>
                        <th colspan="2" class="fechamento"><?= $result[0]->SIS_PRATA ?></th>
                        <?php
                        if ($dif_prata != 0) {
                            echo "<th colspan='2' class='negative'>";
                            echo "<span class='negativetxt'>" . $dif_prata . "</span></th>";
                        } else {
                            echo "<th colspan='2'>";
                            echo $dif_prata;
                        }
                    ...
                    <tr>
                        ...
                        <th colspan="1" class="fechamento"><?= $guiches[0]->GUICHE_ESTUDANTE ?></th>
                        <th colspan="1" class="fechamento"><?= $pastas[0]->PASTA_ESTUDANTE ?></th>
                        <th colspan="1" class="fechamento"><?= $pastas[0]->COF_ESTD ?></th>
                        <th colspan="2" class="fechamento"><?= $result[0]->SIS_ESTD ?></th>
                        <?php
                        if ($dif_estd != 0) {
                            echo "<th colspan='2' class='negative'>";
                            echo "<span class='negativetxt'>" . $dif_estd . "</span></th>";
                        } else {
                            echo "<th colspan='2'>";
                            echo $dif_estd;
                        }
                    ...
                    <tr>
                        ...
                        <th class="fechamento"><?= $pastas[0]->COF_DEVOLVIDOS ?></th>
                        <th colspan="2" class="fechamento"><?= $result[0]->SIS_DEVOL ?></th>
                        <?php
                        if ($dif_devol != 0) {
                            echo "<th colspan='2' class='negative'>";
                            echo "<span class='negativetxt'>" . $dif_devol . "</span></th>";
                        } else {
                            echo "<th colspan='2'>";
                            echo $dif_devol;
                        }
                    ...
                    <tr>
                        ...
                        <th colspan="5" class="dinheiro">R$&nbsp;<?= number_format($apurado, 2, ',', '.') ?></th>
                    </tr>
                    <tr>
                        <th colspan="5" class="dinheiro">Contado</th>
                        <th colspan="5" class="dinheiro">R$&nbsp; <?= number_format($dinheiro[0]->CONTADO, 2, ',', '.') ?></th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th colspan="5" class="dinheiro">&nbsp;Responsavel:&nbsp;&nbsp;&nbsp;<?= $dinheiro[0]->NOM_FUN ?></th>
                        <th colspan="5" class="dinheiro">&nbsp;ID:&nbsp;<?= $dinheiro[0]->ID_FUN ?></th>
                    </tr>
                    </tr>
                    <tr>
                        <th colspan="10" class="ind" style="height: 8px;"></th>
            ...
            <div class="content_sideB">
                ...
                <div class="fild_sideB">
                    ...
                    <fieldset>
                            ...
                            <div class="drop-resp" id="drop-resp">
                                <ul>
                                    ...
                                    if ($result[0]->NOM_RESP == 'INDEFINIDO') {
                                        echo "<br>";
                                        echo "<a class='select-aguard' onclick='abrirNconf() ' id='pop-aguard'>NAO PERTINENTE</a>";
                                        echo "<br>";
                                        echo "<a class='select-atendimento' onclick='abrirconf()' id='pop-ematend'>PERTINENTE</a>";
                                        echo "<br>";
                                    } elseif ($result[0]->NOM_RESP == 'NÃO CONFORME') {
                                        echo "<br>";
                                        ...
                                        echo "<a class='select-aguard' onclick='abrirIndf()' id='pop-aguard'>INDEFINIDO</a>";
                                        echo "<br>";
                                        echo "<a class='select-atendimento' onclick='abrirNconf()' id='pop-ematend'>NAO PERTINENTE</a>";
                                        echo "<br>";
                                    }
                                    ?>
                                </ul>
                        ...
                        <br><br>
                        <textarea class="desc_spt" name="desc_fisc" id="desc_fisc" rows="5"><?= $result[0]->RESP_FINAL ?></textarea>
                        <br><br>
                    </fieldset>
                    <br><br>
                    ...
                    <hr>
                    <br>
                    <textarea class="desc_fisc" name="desc_fisc" id="desc_fisc" rows="15"><?= $result[0]->COMENTSPT ?></textarea>
                    <br><br>
                    &nbsp;&nbsp;<span><b>Resposta DGQ - Athens</b></span>
                    <hr>
                    <br>
                    <textarea class="text-DGQ" name="text-DGQ" id="desc_fisc" rows="20"><?= $result[0]->COMENTDGQ ?></textarea>
                </div>
    ...
    <div class="container-pop-concluido" id="container-pop-concluido">
        <div class="pop-conc">
            <form action="statusConcluido.php" method="POST">
                ...
                <br><br>
                <button name='concluirpop' type="submit" class='concluirpop' id='concluirpop'><b>Concluir</b></button>
    ...
    <div class="container-pop-atend" id="container-pop-atend">
        <div class="pop-atend">
            ...
            <br>
            <br><br>
            <?php echo "<a name='restpop'  class='restpop' id='restpop'  href='#'><b>Em Atendimento</b></a>" ?>
    ...
    <div class="container-pop-aguard" id="container-pop-aguard">
        <div class="pop-aguard">
            ...
            <br>
            <br><br>
            <?php echo "<a name='restpop'  class='restpop' id='restpop'  href='#'><b>Aguardando Terceiro</b></a>" ?>
    ...
    <div class="container-naoconf" id="container-naoconf">
        <div class="pop-naoconf">
            <form action="naoconforme.php" method="POST">
                <h3 class="comentConc">Não Pertinente?</h3>
                <input type="hidden" name="id_caixa" value="">
                <input type="hidden" name="rfc" value="">
                <br><br>
                <label class="label-satisfy" for="text-satisfy"><b>Resposta SPTrans*</b></label>
                <hr>
    ...
    <div class="container-conf" id="container-conf">
        <div class="pop-conf">
            <form action="conforme.php" method="POST">
    ...
    <div class="container-indf" id="container-indf">
        <div class="pop-indf">
            <form action="indefinido.php" method="POST">
